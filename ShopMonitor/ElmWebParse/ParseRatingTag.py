...
class ParseRating(object):
    def __init__(self,resource_path, city, date,save_date_short, err_rest_ids,db):
        ...
        self.sql = "insert into t_e_rest_rating_tag_city_%s values" %save_date_short
    ...
    def run(self):
        f_name = os.path.join(self.resource_path, 'rating_tag.pickle')
        print("解析文件：", f_name)
