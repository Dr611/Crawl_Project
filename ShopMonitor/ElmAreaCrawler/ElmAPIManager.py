...
class ElmAPIManager():
    ...
    def getMenu(self,rest_id,lng,lat):
        ...
        # print('店铺%s,经纬度：%s,%s' % (rest_id, lng, lat))
        print("开始：", url)
        headers = {
...
if __name__ == '__main__':
    ...
    queue = Queue()
    startSaveProcess(queue)
    e = ElmAPIManager(queue,"C:\\Users\\Administrator\\Desktop\\test\\")
    e.getRestInfo("773484","32.055015","118.77943")
    # e.getRestInfo(575226)
    # e.getRestInfo(755087)
    pass
